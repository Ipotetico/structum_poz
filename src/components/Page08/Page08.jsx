...
<h1 style={{fontWeight:'800', fontSize:'4vw', lineHeight:1}}>Structum <span style={{fontSize:'3vw'}}>dlaczego warto zastosować 
w chorobie zwyrodnieniowej stawów?</span></h1>
    ...
    <div onClick={()=>setAnswer1(!answer1)} className="button">
        <h1>Spełnia europejskie standardy <span> leczenia ChZS.<sup>(1)</sup></span> </h1>
    </div>
    <img src={process.env.PUBLIC_URL + `/images/zolta_w_prawo.svg`} alt="" />
    <h1 className={answer1 ? "show" : "hide"}>Połączenie siarczanu chondroityny 
z glukozaminą nie jest zalecane <span>
 przez ESCEO*. <sup>(1)</sup></span></h1>


     <div onClick={()=>setAnswer2(!answer2)} className="button">
        <h1><span>Leczenie uzupełniające objawów ChZS, </span>wszystkie stawy - ChPL.<sup>(2)</sup> </h1>
    </div>
    <img src={process.env.PUBLIC_URL + `/images/zolta_w_prawo.svg`} alt="" />
    <h1 className={answer2 ? "show" : "hide"}>Jedyny siarczan chondroityny 
w Polsce <span>ze wskazaniem w leczeniu ChZS </span>wszystkich stawów.<sup>(2)</sup></h1>


      <div onClick={()=>setAnswer3(!answer3)} className="button">
        <h1>Bezpieczeństwo <span> w długoterminowej
